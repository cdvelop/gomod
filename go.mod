...
require (
	github.com/cdvelop/filehandler v0.0.30 // indirect
	github.com/cdvelop/maps v0.0.8 // indirect
	github.com/cdvelop/object v0.0.63 // indirect
	github.com/cdvelop/unixid v0.0.45 // indirect
...
require (
	...
	github.com/cdvelop/input v0.0.76 // indirect
	github.com/cdvelop/model v0.0.104 // indirect
